...
// function statis(){
// 	let p = document.getElementById('stat').innerHTML;
// 	p = 'ggggg';
// }

// statis();
// // socket.on('statistics', statis);
...
// This function countinue functin addGrassEater() in server
...
function changeWheather(){
	...
	let button5 = document.getElementById("light");
	...
	button5.onclick = lightning;
	function lightning(){
		setTimeout(function(){
			document.body.style.backgroundImage = "url('whit.png')";
		},500)
		document.body.style.backgroundImage = "url('lightning-png-44010.png')";
